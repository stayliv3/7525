...
static char const ident[]="$Id: //BBN_Linux/Branch/Branch_for_Rel_SDK_CUCTC_General_20151029/tclinux_phoenix/apps/public/siproxd-0.5.12/src/plugin_shortdial.c#1 $";
