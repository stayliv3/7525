...
int do_get_dbg_lv(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_dbg_level(&gponDbgLevel) == GPONMGR_FAIL) {
...
int do_get_gemport(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_gemport(&gponGemInfo) == GPONMGR_FAIL) {
...
int do_get_gemcnt(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_gemcounter(&gponGemCounter) == GPONMGR_FAIL) {
...
int do_get_tod_info(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_current_tod(&gponTodCfg) == GPONMGR_FAIL) {
		printf("Exec. Failed: Get the 'tod_info' command failed\n") ;
		return GPONMGR_FAIL;
	}
...
int do_get_tcont(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_tcont(&gponTcontInfo) == GPONMGR_FAIL) {
...
int do_get_eqd_off(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_eqd_offset(&gponEqdOffset) == GPONMGR_FAIL) {
...
int do_get_spf(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_super_frame_counter(&spf) == GPONMGR_FAIL) {
...
int do_get_cnt_type(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_counter_type(&type) == GPONMGR_FAIL) {
...
int do_get_rsp_time(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_response_time(&time) == GPONMGR_FAIL) {
...
int do_get_itl_dly_fine_tune(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_internal_delay_fine_tune(&delay) == GPONMGR_FAIL) {
...
int do_get_burst_mode_overhead(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_burst_mode_overhead(&type) == GPONMGR_FAIL) {
...
int do_get_key_info(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_key_info(&keyInfo) == GPONMGR_FAIL) {
	...
	printf("  Key switch time    :0x%08x\n", keyInfo.aesSpf.Bits.aes_spf_cnt) ;

	/* Show SHADOW key */
	printf("  Encrypt shadow key0:0x%08x\n", keyInfo.shadowKey.aesShadowKey0.Bits.aes_shadow_key0) ;
	printf("  Encrypt shadow key1:0x%08x\n", keyInfo.shadowKey.aesShadowKey1.Bits.aes_shadow_key1) ;
	printf("  Encrypt shadow key2:0x%08x\n", keyInfo.shadowKey.aesShadowKey2.Bits.aes_shadow_key2) ;
	printf("  Encrypt shadow key3:0x%08x\n", keyInfo.shadowKey.aesShadowKey3.Bits.aes_shadow_key3) ;

	/* Show active key */
	printf("  Encrypt active key0:0x%08x\n", keyInfo.activeKey.aesActiveKey0.Bits.aes_active_key0) ;
	printf("  Encrypt active key1:0x%08x\n", keyInfo.activeKey.aesActiveKey1.Bits.aes_active_key1) ;
	printf("  Encrypt active key2:0x%08x\n", keyInfo.activeKey.aesActiveKey2.Bits.aes_active_key2) ;
	printf("  Encrypt active key3:0x%08x\n", keyInfo.activeKey.aesActiveKey3.Bits.aes_active_key3) ;
...
int do_get_block_size(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_dba_block_size(&blockSize) == GPONMGR_FAIL) {
...
int do_get_dying_gasp(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_dying_gasp_mode(&mode) == GPONMGR_FAIL) {
		printf("Exec. Failed: Get the 'dying_gasp' command failed\n") ;
		return GPONMGR_FAIL;
	}

	if(gponmgr_lib_get_dying_gasp_num(&num) == GPONMGR_FAIL) {
		printf("Exec. Failed: Get the 'dying_gasp' command failed\n") ;
		return GPONMGR_FAIL;
	}
...
int do_get_up_traffic(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_up_traffic(&mode) == GPONMGR_FAIL) {
	...
	switch(mode) {
		case XPON_ENABLE:
			printf("Software upstream traffic mode : enable\n") ;
			break;
		case XPON_DISABLE:
			printf("Software upstream traffic mode : disable\n") ;
			break;
		default:
			printf("Software upstream traffic mode error!\n") ;
			return GPONMGR_FAIL;
	}
...
int do_get_sniffer(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_sniffer_gtc(&sniffer) == GPONMGR_FAIL) {
...
int do_get_csr(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_csr() == GPONMGR_FAIL) {
...
int do_get_filter(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_ext_bst_len_ploamd_filter(&enable) == GPONMGR_FAIL) {
	...
	if(gponmgr_lib_get_up_overhead_ploamd_filter(&enable) == GPONMGR_FAIL) {
		printf("Exec. Failed: Get the 'filter' command failed\n") ;
		return GPONMGR_FAIL;
	}
...
int do_get_dba_backdoor(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_dba_backdoor(&dba_backdoor) == GPONMGR_FAIL) {
...
int do_get_dba_slight_modify(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_dba_slight_modify(&dba_slight_modify) == GPONMGR_FAIL) {
...
int do_get_o3_o4_ploam(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_o3_o4_ploam_ctrl(&mode) == GPONMGR_FAIL) {
...
int do_get_tx_sync_off(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_tx_sync(&tx_sync) == GPONMGR_FAIL) {
...
int do_get_interrupt(int argc, char *argv[], void *p)
{
	...
	if(gponmgr_lib_get_int_mask(&mask) == GPONMGR_FAIL) {
