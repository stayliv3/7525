...
/*	name,		func, 			flags,	argcmin,	argc_errmsg */
	{"set",		do_set,			0,		1,			"Set qdma driver status"},
	{"get",		do_get,			0,		1,			"Get qdma driver status"},
...
static int do_set(int argc, char* argv[], void *p)
{
	...
	return subcmd(QdmaSetCmds, argc, argv, (void *)QdmaSetCmds);
}
...
static int do_get(int argc, char* argv[], void *p)
{
	...
	return subcmd(QdmaGetCmds, argc, argv, (void *)QdmaGetCmds);
}
...
{
	argc+=100;
	return subcmd(QdmaDbgCmds, argc, argv, (void *)QdmaDbgCmds);
}
