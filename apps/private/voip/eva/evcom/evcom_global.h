...
command_t gCmdSet[NUM_OF_COMMAND] = {
    ...
    { .code = CMD_CHAN_PLAY_CID_T2,
      ...
      .example = "EVCom >> chanplaycid2 ch=0 cid=1234 cidp=-24 cidf=us mwi=none T9=5 T10=10 T11=4"\
      				"T12=10 T13=8 T14=15",
	...
	.usage = "<strmconfig | sc> st=[channel_id:stream_id] $attr0=[value] $attr1=[value] ...\n" \
	  ...
	  .example = "EVCom >> strmconfig st=0:0 src=192.168.1.1:5566:5567 dst=192.168.1.2:5566:5567 " \
      			"rtptos=46 rtcptos=46 codec=g711a ulcodec=g711a redundant_pt=102 dtmful_pt=97 dtmfdl_pt=98 ptime=20 dtmfr=on dtmfrm=off VAD=on CNG=on dir=sr plc=on jb=f,500,700 ",
#else
	.example = "EVCom >> strmconfig st=0:0 src=192.168.1.1:5566:5567 dst=192.168.1.2:5566:5567 " \
			"rtptos=46 rtcptos=46 codec=g711a ulcodec=g711a redundant_pt=102 ptime=20 dtmfr=on dtmfrm=off VAD=on CNG=on dir=sr plc=on jb=f,500,700",
#endif
#else
#ifdef TCSUPPORT_C1_MS
	.example = "EVCom >> strmconfig st=0:0 src=192.168.1.1:5566:5567 dst=192.168.1.2:5566:5567 " \
      			"rtptos=46 rtcptos=46 codec=g711a ulcodec=g711a redundant_pt=102 dtmful_pt=97 dtmfdl_pt=98 ptime=20 dtmfr=on dtmfrm=off scomp=on dir=sr plc=on jb=f,500,700 ",
#else
	.example = "EVCom >> strmconfig st=0:0 src=192.168.1.1:5566:5567 dst=192.168.1.2:5566:5567 " \
      			"rtptos=46 rtcptos=46 codec=g711a ulcodec=g711a redundant_pt=102 ptime=20 dtmfr=on dtmfrm=off scomp=on dir=sr plc=on jb=f,500,700",
#endif
#endif      			
      .func = cmdStrmConfig},  
