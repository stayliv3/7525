...
/* added by mtk07059_20150320, for redundant mode. */
typedef enum {
...
#endif
	CODEC_T38,
	CODEC_REDUNDANT, //mtk69097_for_redundant
#ifdef V152_SUPPORT
	CODEC_PCMA_VBD, /*mtk08176 for vbd*/
	CODEC_PCMU_VBD, /*mtk08176 for vbd*/
#endif
	CODEC_INVALID
} codec_e;

#define MAX_CODEC_NUM            (CODEC_REDUNDANT+1) /* mtk69097_for_redundant */
...
#ifdef AMR_CODEC
#define MASK_CODEC_AMR	(1 << CODEC_AMR) //isabella_130830_AMR
#endif
...
/* Bit rate, added by mtk07059_20150811. */
typedef enum { 
    EVA_BR_NONE,
	EVA_G7231_5300,
	EVA_G7231_6300,
...
typedef enum {
	...
	EVA_LOG_ERR = 1,	/* Log level ERROR */
	EVA_LOG_WARN = 2,	/* Log level WARNING */
	EVA_LOG_DBG = 3,	/* Log level DEBUG */
	EVA_LOG_INFO = 4,	/* Log level INFO */
