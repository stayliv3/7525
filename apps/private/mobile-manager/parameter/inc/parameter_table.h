...
int SetOSResource(int pid,PluginResource_ptr pResource);
int GetRight1Resource(char *plgName,PluginResource_ptr pResource);
int SetRight1Resource(int pid,PluginResource_ptr pResource);
