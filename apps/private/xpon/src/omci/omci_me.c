...
{OMCI_CLASS_ID_ETHERNET_FRAME_EXTENDED_PM,				"Ethernet frame extended PM",			OMCI_ME_ACCESS_OLT, OMCI_ME_SUPPORT,            omciMeInitForEthernetFrameExtendedPM ,      {NULL},	    omciAttriDescriptListMBEthnetFrameExtendedPM,       {PTHREAD_MUTEX_INITIALIZER , NULL},     NULL, NORMAL },
...
{OMCI_CLASS_ID_RESERVED_350_ME, 				"reserved 350 ME",					OMCI_ME_ACCESS_ONU, OMCI_ME_SUPPORT,	omciMeInitFor350ME,					{NULL}, omciAttriDescriptListReserved350, 				{PTHREAD_MUTEX_INITIALIZER , NULL},  NULL,UNNEED_MIB_UPLOAD},
#endif
...
{OMCI_CLASS_ID_RESERVED_353_ME, 				"reserved 353 ME",					OMCI_ME_ACCESS_ONU, OMCI_ME_SUPPORT,	omciMeInitFor353ME,					{NULL}, omciAttriDescriptListReserved353, 				{PTHREAD_MUTEX_INITIALIZER , NULL},  NULL,UNNEED_MIB_UPLOAD},
{OMCI_CLASS_ID_RESERVED_367_ME, 				"reserved 367 ME",					OMCI_ME_ACCESS_ONU, OMCI_ME_SUPPORT,	omciMeInitFor367ME,					{NULL}, omciAttriDescriptListReserved367, 				{PTHREAD_MUTEX_INITIALIZER , NULL},  NULL,UNNEED_MIB_UPLOAD},
{OMCI_CLASS_ID_RESERVED_373_ME, 				"reserved 373 ME",					OMCI_ME_ACCESS_ONU, OMCI_ME_SUPPORT,	omciMeInitFor373ME, 				{NULL}, omciAttriDescriptListReserved373,				{PTHREAD_MUTEX_INITIALIZER , NULL},  NULL,UNNEED_MIB_UPLOAD},
#endif
#ifdef TCSUPPORT_VOIP
