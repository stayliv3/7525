...
********************************************************************************************************************************/
static AttributeFunc EthnetFrameExtendedPMFunc = {
	getEthnetFrameExtendedPMFunc,
	setEthnetFrameExtendedPMFunc
};
...
{0,   "meId",					     2,	ATTR_ACCESS_R_SET_CREATE,	ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT,		NO_AVC,	&EthnetFrameExtendedPMFunc},
{1,   "interval end time",	         1,	ATTR_ACCESS_R,	            ATTR_FORMAT_UNSIGNED_INT,   0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT,		NO_AVC,	&EthnetFrameExtendedPMGetFunc},
{2,   "control block",    	         16,ATTR_ACCESS_R,	            ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
...
{11,  "oversize frames", 	         4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{12,  "frames 64 octets",	         4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{13,  "frames 65 to 127 octets",	 4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{14,  "frames 128 to 255 octets",	 4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{15,  "frames 256 to 511 octets",	 4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{16,  "frames 512 to 1023 octets",   4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{17,  "frames 1024 to 1518 octets",  4,	ATTR_ACCESS_R,				ATTR_FORMAT_UNSIGNED_INT,	0,		0,		0,	NULL,	ATTR_FULLY_SUPPORT, 	NO_AVC, &EthnetFrameExtendedPMGetFunc},
{255, "",                            0, 0,                          0,                          0,      0,      0,  NULL,   0,                      0,      NULL}
};
