...
#define OMCI_TCA_ID_RTP_PACKET_LOSS						     	    (OMCI_CLASS_ID_RTP_PM_HISTORY_DATA<<16|0x1)
#define OMCI_TCA_ID_RTP_PACKET_JITTER						     	(OMCI_CLASS_ID_RTP_PM_HISTORY_DATA<<16|0x2)
#define OMCI_TCA_ID_RTP_NO_RTCP_PACKET						     	(OMCI_CLASS_ID_RTP_PM_HISTORY_DATA<<16|0x3)
#define OMCI_TCA_ID_RTP_TIMEOUT					     	            (OMCI_CLASS_ID_RTP_PM_HISTORY_DATA<<16|0x4)
#define OMCI_TCA_ID_RTP_BUFFER_UNDERFLOWS			            	(OMCI_CLASS_ID_RTP_PM_HISTORY_DATA<<16|0x5)
#define OMCI_TCA_ID_RTP_BUFFER_OVERFLOWS			             	(OMCI_CLASS_ID_RTP_PM_HISTORY_DATA<<16|0x6)
...
#define OMCI_RTP_PM_PacketLoss		"PacketsLost"
#define OMCI_RTP_PM_MaxJitter	"ReceiveInterarrivalJitter"
#define OMCI_RTP_PM_MaxTimeBetRTCP  "TxRepeatInterval"
