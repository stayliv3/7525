...
account_boot(mxml_node_t *top){
	...
	system("iptables -t filter -A PORTS_LIMIT -p TCP -m multiport --dport 53,3555,5555,49152 -i ppp+ -j DROP");
	system("iptables -t filter -A PORTS_LIMIT -p TCP -m multiport --dport 53,3555,5555,49152 -i nas+ -j DROP");
