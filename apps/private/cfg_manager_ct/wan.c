...
//	tcdbg_printf("wanInfo_read begin:%s,%s!\n", name[0], name[1]);
	...
	int 	n = 0;
	char	strbinding[128] = {0};
	char	strbindtemp[64] = {0};
	int	iIPv4[8] = {0}, iIPv6[8] = {0};
...
#if defined(TCSUPPORT_CT_DSLITE)
	int dslite = 0;
	int iIfindexV4[8] = {-1, -1, -1, -1, -1, -1, -1, -1};
	int iIfindexV6[8] = {-1, -1, -1, -1, -1, -1, -1, -1};
#endif
#endif
...
{
	char nodeName[MAX_ARG_NUM][MAX_NODE_NAME];
	char dhcpv6_getpd[8] = {0}, dhcpv6_pdorig[8] = {0};
