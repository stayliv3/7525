...
#slave image from 0x730000, main image with 7.0M
let "remainder_m=0x700000-0x100-$size_k-$size_r-$remainder_r-$remainder_k"
if [ 0 -gt $remainder_m ];then
	echo "main image is more than 7.0M,remainder_m=$remainder_m"
	exit 1;
fi
